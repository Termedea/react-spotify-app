        ...
        return (
            <div className="UserProfile  main-component bg-gradient-to-tr from-green-600 to-acc-green rounded-xl">
                ...
                <p className="text-acc-green-darker">
                    ...
                    Occaecat est est nostrud duis reprehenderit elit occaecat
                    incididunt elit irure et. Aliquip ullamco incididunt mollit
                    sint commodo adipisicing est eu commodo est ex.
                </p>
            </div>
        );
    }
